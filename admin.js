...
(function () {
  ...
  const BUILTIN_PACKS = [
    ...
    { file: "questions/kendricklamar.json", label: "Kendrick Lamar" },
    { file: "questions/grammys.json", label: "Grammy's" },
    { file: "questions/bestsellingalbums.json", label: "Best Selling Albums" },
    { file: "questions/movietrivia.json", label: "Movie Trivia" },
    { file: "questions/tubimovies.json", label: "Tubi Movies" },
    { file: "questions/truecrime.json", label: "True Crime" },
    { file: "questions/romance.json", label: "Romance" },
    { file: "questions/queens.json", label: "Queens" },
    { file: "questions/nyclandmarks.json", label: "NYC Landmarks" },
    { file: "questions/fiveboroughs.json", label: "Five Boroughs" },
    { file: "questions/fashion.json", label: "Fashion" },
    { file: "questions/hypebeast.json", label: "HypeBeast" },
    { file: "questions/sneakers.json", label: "Sneakers" },
    { file: "questions/gossip.json", label: "Gossip" },
